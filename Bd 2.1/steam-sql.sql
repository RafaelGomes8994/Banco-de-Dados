...
-- -----------------------------------------------------
-- Table `mydb`.`Usuario_has_Compra_has_Produto`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`Usuario_has_Compra_has_Produto` (
...
CREATE TABLE IF NOT EXISTS `mydb`.`Nota_Fiscal` (
  ...
  CONSTRAINT `fk_Nota Fiscal_Compra1`
    ...
    REFERENCES `mydb`.`Usuario_has_Compra_has_Produto` (`id_compra`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION);
